...
class Obstacle:
    ...
    def compute_static_obstacle_cost(self, trajectories, cutoff_distance=0.3):
    ...
    def compute_dynamic_obstacle_cost(self, trajectories, horizon, dt, cutoff_distance=0.3):
